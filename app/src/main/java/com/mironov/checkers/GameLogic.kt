...
class GameLogic : ViewModel() {
    ...
    /**
     * @param i1 picked chip index i
     * @param j1 picked chip index j
     * @param i2 tile index i to move to
     * @param j2 tile index j to move to
     */
     ...
     * @param i picked chip index i
     * @param j picked chip index j
     */
    fun getAllowedMoves(
        i: Int,
        j: Int
